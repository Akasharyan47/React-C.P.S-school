...
import ViewAllModal from "./ViewAll";
  ...
  return (
    <>
      <Main>
              ...
              {images && images.length > 0 && images.map((slide, index) => {
                return (
                  <div key={index} className="slider-card">
                    <div className="slider-card-image" style={{ 'backgroundImage': `url(${slide})`, backgroundSize: 'cover' }} ></div>
                  </div>
                )
              })
              }
        ...
        <button
              className="btn bg-success viewAll btn-lg"
              type="button"
